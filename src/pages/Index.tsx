...
// import AIAssistant from '@/components/AIAssistant'; // Removed AI integration
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center min-h-[600px]">
            <div className="lg:col-span-6 xl:col-span-5">
              <div className="space-y-6">
                <div>
                  <h1 className="text-4xl sm:text-5xl lg:text-5xl xl:text-6xl font-bold text-gray-900 dark:text-gray-100 leading-tight">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Button asChild size="lg" className="btn-premium text-base lg:text-lg px-6 lg:px-8 py-3 lg:py-4 rounded-xl shadow-xl">
                    <Link to="/marketplace">
                  ...
                  <Button asChild variant="outline" size="lg" className="text-base lg:text-lg px-6 lg:px-8 py-3 lg:py-4 rounded-xl border-2 border-orange-200 hover:border-orange-500 hover:text-orange-600 relative overflow-hidden group">
                    <Link to="/auth">
            ...
            <div className="lg:col-span-6 xl:col-span-7">
              <div className="relative">
                ...
                <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-2xl border border-gray-100 dark:border-gray-700">
                  ...
                  <Button variant="ghost" className="w-full mt-4 text-orange-600 hover:text-orange-700 hover:bg-orange-50 dark:hover:bg-orange-900/20 dark:text-orange-400">
                    View All Items →
                  </Button>
                </div>
              </div>
      ...
      {/* Testimonials */}
      <section className="py-20 bg-gradient-to-r from-orange-50 to-cyan-50 dark:from-gray-800 dark:to-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">
              What Students Say
            ...
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="border-0 shadow-lg bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:shadow-xl transition-shadow">
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center">
                    <div className="w-12 h-12 bg-gradient-to-r from-orange-500 to-cyan-600 rounded-full flex items-center justify-center text-white font-bold text-lg mr-4">
                      {testimonial.name.charAt(0)}
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-900 dark:text-gray-100">{testimonial.name}</h4>
                      <p className="text-sm text-gray-500 dark:text-gray-400">{testimonial.role}</p>
                      <p className="text-sm text-orange-600 dark:text-orange-400">{testimonial.university}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
